...
// import { Mail, Phone, MapPin, Calendar, Github, Linkedin, Send, Youtube, Instagram } from "lucide-react"
...
//                   >
//                     <div className="text-muted-foreground">{social.icon}</div>
//                     <div>
