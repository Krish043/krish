        ...
        <Tabs defaultValue="overview" className="w-full">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    I&apos;m a Developer, Freelancer and CSE undergraduate at
                    Nirma University, focused on building dynamic WebApps using
                    the MERN stack and Next.js. Passionate about improving my
                    skills, especially in AI and ML, exploring their real-world
                    applications. Through continuous learning and personal
                    projects, I aim to stay at the forefront of technology and
                  ...
                  <div className="p-3 border rounded-lg hover:bg-accent/50 transition-colors">
                    <div className="flex flex-col sm:flex-row items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-1 md:gap-3 mt-2">
          ...
          <TabsContent value="personal" className="space-y-4 md:space-y-6">
                ...
                <CardContent className="space-y-2 md:space-y-3">
                  {[
                    ...
                    >
                      ...
                      <Badge
                        className={`text-xs md:text-sm ${lang.levelClass}`}
                      >
                        {lang.level}
                      </Badge>
                    </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3 md:space-y-4">
                  <div className="group relative p-3 md:p-4 border rounded-lg hover:bg-accent/50 transition-colors">
                    ...
                    <Dialog>
                      <DialogTrigger asChild>
                        <Button
                          variant="ghost"
                          size="sm"
                          className="relative sm:absolute right-0 sm:right-4 bottom-0 sm:bottom-4 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity mt-2 sm:mt-0"
                        >
                          <ImageIcon className="h-4 w-4 mr-2" /> View Glimpses
                        </Button>
                      </DialogTrigger>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Newspaper className="h-5 w-5" /> Achievements
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 md:space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="group relative p-3 md:p-4 border rounded-lg hover:bg-accent/50 transition-colors"
                    >
                      <div className="flex items-start gap-3">
                        <div className="p-1.5 rounded-md bg-accent mt-0.5">
                          {item.icon}
