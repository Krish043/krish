...
export function Navbar() {
  ...
  const gradientClass = "bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent";
    ...
    <nav className="fixed top-0 w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-md z-50 border-b border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link
            href="/"
            className={`flex items-center gap-2 font-bold text-xl ${gradientClass} flex-shrink-0`}
          >
            <FaReact className="text-3xl" />
            Krish
          </Link>
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-gray-200 dark:border-gray-800">
            <div className="flex flex-col space-y-4">
              ...
              <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 transition-colors mt-2"
                asChild
              >
                <Link href="/resume.pdf" download>
                  <Download className="mr-2 h-5 w-5" />
